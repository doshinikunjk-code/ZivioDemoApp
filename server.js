...
app.post('/api/claude', async (req, res) => {
  try {
    const r = await httpsPost(
      ...
      { 'Content-Type':'application/json', 'x-api-key':'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', 'anthropic-version':'2023-06-01' },
      req.body
    );
...
app.post('/api/claude/stream', async (req, res) => {
  ...
  const reqH = {
    ...
    'x-api-key': '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',
